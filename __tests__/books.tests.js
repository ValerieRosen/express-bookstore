...
beforeEach(async () => {
  let result = await db.query(`
    INSERT INTO
      ...
      VALUES(
        '123432122',
        'https://amazon.com/wombats',
        'Greek Tragedy',
        'English',
        700,
        'Wombat publishing',
        'The history of Wombats', 2013)
      RETURNING isbn`);
...
describe("POST /books", function () {
  test("Creates a new book", async function () {
    const response = await request(app).post(`/books`).send({
      isbn: "12345678",
      amazon_url: "https://wombats.com",
      author: "Joe Cool",
      language: "english",
      pages: 1000,
      publisher: "Marksman publishing",
      title: "World Peace",
      year: 2000,
    });
